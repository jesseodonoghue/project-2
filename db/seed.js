module.exports = (db) => {
  ...
  db.Drink.create({
    ...
    db.Drink.create({
      ...
      basePrice: 4.00,
      img: '../public/images/cappucino.png'
    });
  }).then(() => {
    db.Drink.create({
    ...
    db.Drink.create({
      ...
      basePrice: 4.00,
      img: '../public/images/macchiato.png'
    });
  }).then(() => {
    db.Drink.create({
      name: 'Americano',
      ...
      basePrice: 3.00,
      img: '../public/images/americano.png'
    });
  }).then(() => {
    db.Drink.create({
      name: 'Hot Cocoa',
      ...
      basePrice: 3.00,
      img: '../public/images/hot-cocoa.png'
    });
  }).then(() => {
    db.Drink.create({
      name: 'Vanilla Spice',
      ...
      basePrice: 3.00,
      img: '../public/images/vanilla-spice.png'
    });
  });
};
